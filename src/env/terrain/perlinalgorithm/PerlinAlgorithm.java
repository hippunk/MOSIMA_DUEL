 ...
 * 
 * The algorithm generates a random map,
 *  then selectec specific points regularly distant (the frequency value define the number of points),
 *  then the interpolation process is triggered.
 *  
 * 
 * @author WonbinLIM, hc
 *
