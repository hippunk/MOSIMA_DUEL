...
/**
 * In order to use prolog you must install swi-prolog and the jpl library for your distribution
 * 
 * http://www.swi-prolog.org/
 * jpl7.org
 * 
 * Under linux the jpl.jar library must be generated through the compilation of the swiprolog + packages sources 
 * (the packages are not included in the ubuntu default install)
 * 
 * http://www.codecompiling.net/node/137
 * 
 * Once its installed, you can find several examples (including the following) in the jpl package.
 */
